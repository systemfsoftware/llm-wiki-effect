  ...
  return (
    <div className='space-y-6'>
      ...
      >
        ...
        >
          <span
            className={`text-xs font-semibold ${draft.multimodalEnabled ? 'text-primary' : 'text-muted-foreground'}`}
          >
            {draft.multimodalEnabled
            ...
            <div className='space-y-4 rounded-md border p-3'>
              ...
              <div className='space-y-2'>
                ...
                <select
                  ...
                  onChange={(e) => {
                    const provider = PROVIDER_OPTIONS.find((option) => option.value === e.target.value)?.value
                    if (provider) setDraft('multimodalProvider', provider)
                  }}
                >
              ...
              {(draft.multimodalProvider === 'custom' || draft.multimodalProvider === 'azure') && (
                <div className='space-y-2'>
                  ...
                  <Input
                    ...
                    placeholder={draft.multimodalProvider === 'azure'
                  ...
                  <div className='space-y-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        if (family === 'auto' || family === 'gpt5') {
                          setDraft('multimodalAzureModelFamily', family)
                        }
                      }}
                    >
