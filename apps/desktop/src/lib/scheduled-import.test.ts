...
import type { discardTasksForSources, enqueueInactiveProjectBatch } from '@/lib/ingest-queue'
import type {
  getRecentProjects,
...
const mocks = vi.hoisted(() => ({
  copyFile: vi.fn<typeof copyFile>(),
  fileExists: vi.fn<typeof fileExists>(),
  getFileMd5: vi.fn<typeof getFileMd5>(),
  getFileSize: vi.fn<typeof getFileSize>(),
  listDirectory: vi.fn<typeof listDirectory>(),
  preprocessFile: vi.fn<typeof preprocessFile>(),
  readFile: vi.fn<typeof readFile>(),
  writeFileAtomic: vi.fn<typeof writeFileAtomic>(),
  enqueueSourceIngest: vi.fn<typeof enqueueSourceIngest>(),
  deleteSourceFile: vi.fn<typeof deleteSourceFile>(),
  discardTasksForSources: vi.fn<typeof discardTasksForSources>(),
  isIngestableSourcePath: vi.fn<typeof isIngestableSourcePath>(),
  loadScheduledImportConfig: vi.fn<typeof loadScheduledImportConfig>(),
  saveScheduledImportConfig: vi.fn<typeof saveScheduledImportConfig>(),
  getRecentProjects: vi.fn<typeof getRecentProjects>(),
  loadSourceWatchConfig: vi.fn<typeof loadSourceWatchConfig>(),
  enqueueInactiveProjectBatch: vi.fn<typeof enqueueInactiveProjectBatch>(),
  folderContextForSourcePath: vi.fn<typeof folderContextForSourcePath>(),
}))
