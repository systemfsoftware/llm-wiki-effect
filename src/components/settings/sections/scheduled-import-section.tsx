...
import { isProjectManagedScheduledImportPath, resolveImportPath, scanAndImport } from '@/lib/scheduled-import'
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <p className='mt-1 text-sm text-muted-foreground'>
          {t('settings.sections.scheduledImport.description', {
            defaultValue: 'Automatically monitor a directory and import new or modified files at regular intervals.',
          })}
        </p>
      </div>
      ...
      <div className='flex items-center gap-4'>
        ...
        >
          {isScanning ? <RefreshCw className='mr-2 h-4 w-4 animate-spin' /> : <Play className='mr-2 h-4 w-4' />}
          {isScanning
