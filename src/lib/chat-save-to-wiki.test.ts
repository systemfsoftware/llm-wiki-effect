...
import { cleanAssistantContentForWikiSave, titleFromCleanAssistantContent } from './chat-save-to-wiki'
...
describe('chat save-to-wiki helpers', () => {
  ...
  it('falls back for empty visible content', () => {
    expect(titleFromCleanAssistantContent(cleanAssistantContentForWikiSave('<thinking>all</thinking>'))).toBe(
      'Saved Query',
    )
