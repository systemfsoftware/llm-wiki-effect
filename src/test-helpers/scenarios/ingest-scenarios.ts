...
export const ingestScenarios: IngestScenario[] = [
  // 1. basic-new-source — new concept wiki page + source summary, no reviews
  {
    ...
    description: 'Stage 2 emits a single concept page + a source summary page. No ' +
  ...
  // 2. generates-review-items — REVIEW blocks in generation become store items
  {
    ...
    description: 'Stage 2 emits one FILE and two REVIEW blocks (missing-page + ' +
  ...
  // 3. references-existing-wikilinks — generated pages link to existing pages
  {
    ...
    description: 'The generated wiki page must include [[attention]] — linking back ' +
    ...
    analysisResponse: '## Connections to Existing Wiki\n' +
  ...
  {
    name: 'chinese-source',
    description: 'Chinese-language source document; LLM responses in Chinese. ' +
