...
export const lintScenarios: LintScenario[] = [
  // 1. clean-wiki — fully interlinked, no findings
  {
    ...
    description: 'Two content pages cross-link each other. No orphans, no broken ' +
  ...
  // 2. orphan-page — no inbound wikilinks
  {
    ...
    description: 'orphan.md links out to attention.md but no content page links BACK ' +
  ...
  // 3. broken-link — wikilink to a page that doesn't exist
  {
    ...
    description: 'attention.md contains a wikilink to [[nonexistent-page]] which has ' +
  ...
  // 4. no-outlinks — a page has zero [[wikilinks]]
  {
    ...
    description: 'leaf.md is linked-to by transformer.md but has no outgoing links ' +
  ...
  // 5. semantic-contradiction (LLM-backed)
  {
    ...
    description: 'Two cross-linked pages make conflicting claims. Structural lint ' +
