...
export const sweepScenarios: SweepScenario[] = [
  // 1. missing-page/filename-match
  {
    ...
    description: "Review says the wiki is missing an 'attention' page. A page named " +
    ...
    reviews: [
      {
        ...
        description: 'Transformer page references attention but no dedicated page exists.',
  ...
  // 2. missing-page/title-match
  {
    ...
    description: "Review asks about 'Attention Mechanism'. The filename is 'attn.md' " +
  ...
  // 3. missing-page/chinese-prefix-variant
  {
    ...
    description: "Review title uses the Chinese '缺失页面：' prefix variant. The wiki " +
  ...
  // 4. missing-page/not-resolved
  {
    ...
    description: 'Review asks about a page that genuinely does not exist in the wiki ' +
  ...
  // 5. missing-page/case-insensitive
  {
    ...
    description: 'Review title uses ALL-CAPS. Filename is lowercase. Match must be ' +
      'case-insensitive.',
    initialWiki: {
      'purpose.md': SHARED_PURPOSE,
      'wiki/attention.md': page('Attention', '...'),
  ...
  // 6. missing-page/kebab-vs-space
  {
    ...
    description: "Review says 'Missing page: attention mechanism' (space). Wiki has " +
  ...
  // 7. duplicate/one-page-deleted
  {
    ...
    description: 'A duplicate review flagged that attention.md and attention-v2.md ' +
    ...
    reviews: [
      {
        ...
        description: 'attention.md and attention-v2.md cover the same material and ' +
  ...
  // 8. duplicate/both-present
  {
    ...
    description: "Both duplicated pages still exist — user hasn't resolved it yet. " +
  ...
  // 9. contradiction/never-auto-resolves
  {
    ...
    description: 'Contradiction items require human judgment and must NEVER be ' +
    ...
    reviews: [
      {
        ...
        description: 'attention.md says softmax, transformer.md says linear. One must ' +
  ...
  // 10. suggestion/stays-pending-by-default
  {
    ...
    description: 'Suggestion items are conservative by design — the rule stage ' +
  ...
  // 11. llm-judged/semantic-match
  {
    ...
    description: "Rule stage can't match 'Missing: Context Window' to any existing " +
  ...
  // 12. mixed-batch/partial-resolution
  {
    ...
    description: 'A mix of reviews: one resolvable by rules (filename match), one ' +
